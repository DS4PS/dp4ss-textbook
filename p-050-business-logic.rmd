...
Logical statements translate human languages into computer code. 
...
**Translated to R as a logical statement:**
...
Be careful with the order of operations though!
...
Note that this is NOT women in the control group:
