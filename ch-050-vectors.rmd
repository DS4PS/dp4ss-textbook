...
Note in this example the **plot()** function produced two different types of graphs.

R uses the object type to determine behavior. This is called object-oriented programming. It makes the process of creating data recipes much faster!

We will revisit this concept more later. 
