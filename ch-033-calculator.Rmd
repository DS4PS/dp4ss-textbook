...
* Calculations follow the order of operations, or **PEMDAS**
* Create **objects** with **assignment**, e.g. `x` contains `3` in `x <- 3`
* Use numeric objects like variables in algebra, e.g. `x + 2` equals `5`
...
(17 - 7) + 3      # Parantheses are evaluated first
...
# Subtract 1,000 from 10 cubed (raised to third power)
